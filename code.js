...
var parkline1 = createSprite(windowWidth/2+50, windowHeight/2-240,15,160);
...
var playerCar = createSprite(windowWidth/2+100,windowHeight/2);
...
function setup(){
  ...
  up = createSprite(windowWidth/2-150,windowHeight-100);
  up.scale= 0.09;
  up.addImage(upImg);

  down = createSprite(windowWidth/2+150,windowHeight-100);
  down.scale= 0.25;
  down.addImage(downImg);

  left = createSprite(windowWidth/2-420,windowHeight+10);
  left.scale= 0.25;
  left.addImage(leftImg);
  
  right = createSprite(windowWidth/2+420,windowHeight+10);
  right.scale= 0.25;
